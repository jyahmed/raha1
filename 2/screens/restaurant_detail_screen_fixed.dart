...
class RestaurantDetailScreen extends StatefulWidget {
  final Restaurant restaurant; // هذا السطر يجب أن يكون موجوداً

  const RestaurantDetailScreen({
    super.key,
    required this.restaurant, // وهذه المعلمة مطلوبة
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark
          ...
          : const Color.fromARGB(255, 58, 223, 245),
      ...
      bottomNavigationBar: Consumer<CartProvider>(
        builder: (context, cart, child) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              color: isDark ? const Color(0xFF1E1E1E) : const Color(0xFFFFC72C),
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(0.1),
                  blurRadius: 10,
