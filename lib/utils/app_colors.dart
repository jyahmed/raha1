...
class AppColors {
  ...
  // Special Colors
  static const Color rating = Color(0xFFFBBF24); // Amber for ratings
  static const Color discount = Color(0xFFEF4444); // Red for discounts
  static const Color delivery = Color(0xFF10B981); // Green for delivery
  static const Color favorite = Color(0xFFEC4899); // Pink for favorites
}
